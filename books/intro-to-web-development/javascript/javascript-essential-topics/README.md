...
So, JavaScript is a very versatile language:

* JavaScript does not need to have a web page to run
  * a web page, however, _could_ benefit from JavaScript
...
* Methods
  * Functionality
    ...
    * Middle-of-array: splice, slice
    * Combination: join, split, concat
    * Order: reverse, sort
