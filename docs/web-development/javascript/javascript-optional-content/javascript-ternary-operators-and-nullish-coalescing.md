...
{% hint style="danger" %}
**Nullish coalescing** [may not work](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish\_coalescing\_operator#browser\_compatibility) in some browsers such as Internet Explorer, but **ternary operators** have [greater compatibility](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Conditional\_Operator#browser\_compatibility)
{% endhint %}
