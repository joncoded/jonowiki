...
![](../../../.gitbook/assets/docs-react-atom.png)
...
You will almost never touch this file because React puts everything inside of the `<div id="root">`via the other files ... however, to clean up:
...
<html lang="en">
  ...
  <body>
    ...
    <noscript>Why do you hate JavaScript?</noscript>
    <div id="root"></div>
