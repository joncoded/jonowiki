...
{% embed url="https://www.youtube.com/watch?v=Do0tl\_u0WZk&feature=emb\_title" %}
...
\(This will create a new `package.json` file that lists metadata as well as, most importantly, what **dependencies** this project will have, so anyone who picks up this project will know dependencies to download!\)

* Save your **Workspace** in another folder \(preferably not your project folder\)
  * Click on "File" then "Save Workspace as..."
  * This will tell VSC what files are opened the next time you open the Workspace
* Have fun coding!

{% embed url="https://www.youtube.com/watch?v=47GaFnnex5w&feature=emb\_title" %}
